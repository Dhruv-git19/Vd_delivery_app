    ...
    return const Scaffold(
      ...
      body: Center(
        child: Column(
          ...
          children: [
            Icon(Icons.fire_truck_outlined, size: 28, color: Colors.white),
            SizedBox(height: 8),
            Text("Vedasip Delivery", style: TextStyle(color: Colors.white, fontSize: 24, fontWeight: FontWeight.bold)),
          ],
        ),
      ),
    );
